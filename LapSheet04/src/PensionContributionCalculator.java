...
public class PensionContributionCalculator {
	...
	public static void main(String[] args) {
		...
		employerContribution = 0, totalContribution = 0;
		
		
		
		System.out.printf("Enter the monthly salary : $ ");
		salary = scan.nextInt();
		...
		if(age <= 55) {
			...
			employerContribution = contributableSalary*EMPLOYEE_RATE_60_TO_65;
			totalContribution = employeeContribution;
		}else {
		...
		System.out.printf("\nThe employer's contribution is : %.2f ",
